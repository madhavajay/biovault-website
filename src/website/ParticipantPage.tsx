			...
			<div className="hero-content">
				...
				<div className="app-store-buttons">
					<a
						...
						onclick="event.preventDefault(); alert('Sign up for beta access below to get TestFlight access.');"
					>
					...
					<a
						...
						onclick="event.preventDefault(); alert('Sign up for beta access below to get Google Play access.');"
					>
						<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
