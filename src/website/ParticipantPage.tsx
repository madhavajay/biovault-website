			...
			<div className="hero-content">
				...
				<div className="app-store-buttons">
					<a
						...
						onclick="event.preventDefault(); if(window.rybtt) { window.rybtt.trackEvent('install_click', { platform: 'ios', source: 'participant_hero' }); } document.getElementById('modal-message').textContent = 'Sign up for beta access below to get TestFlight access.'; document.getElementById('modal-icon').className = 'modal-icon success'; document.getElementById('message-modal').style.display = 'flex';"
					>
					...
					<a
						...
						onclick="event.preventDefault(); if(window.rybtt) { window.rybtt.trackEvent('install_click', { platform: 'android', source: 'participant_hero' }); } document.getElementById('modal-message').textContent = 'Sign up for beta access below to get Google Play access.'; document.getElementById('modal-icon').className = 'modal-icon success'; document.getElementById('message-modal').style.display = 'flex';"
					>
						<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
