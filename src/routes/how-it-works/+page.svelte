		...
		<div class="lg:grid lg:grid-cols-[200px_1fr] lg:gap-12">
			...
			<main class="py-8 lg:py-12 max-w-3xl">
				...
				<section id="secure-computation" class="scroll-mt-28 lg:scroll-mt-24 mb-16">
					...
					<p class="text-sm text-muted-foreground leading-relaxed mb-4">
						Federated computation across multiple datasites requires exchanging intermediate results. Sharing this data in plaintext raises privacy concerns — even aggregate statistics can enable reconstruction or membership inference attacks.
					</p>
					<p class="text-sm text-muted-foreground leading-relaxed mb-6">
